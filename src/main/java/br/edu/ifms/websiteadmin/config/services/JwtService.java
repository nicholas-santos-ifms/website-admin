...
public class JwtService {
    ...
    /**
     * Extração de claim. MÃ©todo criado para extrair dados (claim) do token
     *
     * @param <T>
     * @param token
    ...
    /**
     * Geração do token. MÃ©todo usado para criar um token baseado no usuÃ¡rio e
    ...
    private Claims extractAllClaims(String token) {
        try {
            ...
            LOGGER.debug(e.getMessage(), e.getCause());
            throw new UsuarioNotFoundException("Token invÃ¡lido");
        } catch (Exception e) {
